...
def ps_register_basis(name, Rs, V, length=0.02, radius=0.0015, enabled=True, **wargs):
    pc = ps.register_point_cloud(name, V, radius=1e-4, enabled=enabled, **wargs)

    pc.add_vector_quantity(
        "x", Rs[..., 0], radius=radius, length=length, enabled=True, **wargs
    )
    pc.add_vector_quantity(
        "y", Rs[..., 1], radius=radius, length=length, enabled=True, **wargs
    )
    pc.add_vector_quantity(
        "z", Rs[..., 2], radius=radius, length=length, enabled=True, **wargs
    )
...
def gen_idx_0(xx, yy, zz):
    idx_0 = np.concatenate(
        [
            ...
            (
                xx[2::2, 1::2, 1:-1:2] + yy[2::2, 1::2, 1:-1:2] + zz[2::2, 1::2, 1:-1:2]
            ).reshape(-1),
            (
                xx[1::2, 2::2, 1:-1:2] + yy[1::2, 2::2, 1:-1:2] + zz[1::2, 2::2, 1:-1:2]
            ).reshape(-1),
        ]
    )
    idx_1 = np.concatenate(
        [
            (xx[1::2, ::2, ::2] + yy[1::2, ::2, ::2] + zz[1::2, ::2, ::2]).reshape(-1),
            (
                xx[2:-1:2, 1:-1:2, ::2]
                + yy[2:-1:2, 1:-1:2, ::2]
                + zz[2:-1:2, 1:-1:2, ::2]
            ...
            (
                xx[::2, 2::2, 1:-1:2] + yy[::2, 2::2, 1:-1:2] + zz[::2, 2::2, 1:-1:2]
            ).reshape(-1),
        ]
    )
    idx_2 = np.concatenate(
        [
            (xx[1::2, 1::2, ::2] + yy[1::2, 1::2, ::2] + zz[1::2, 1::2, ::2]).reshape(
                -1
            ),
            (
                xx[2:-1:2, 2:-1:2, ::2]
    ...
    idx_3 = np.concatenate(
        [
            (xx[::2, 1::2, ::2] + yy[::2, 1::2, ::2] + zz[::2, 1::2, ::2]).reshape(-1),
            (
                xx[1:-1:2, 2:-1:2, ::2]
                + yy[1:-1:2, 2:-1:2, ::2]
                + zz[1:-1:2, 2:-1:2, ::2]
    ...
    idx_4 = np.concatenate(
        [
            (xx[::2, ::2, 1::2] + yy[::2, ::2, 1::2] + zz[::2, ::2, 1::2]).reshape(-1),
            (
                xx[1:-1:2, 1:-1:2, 1::2]
                + yy[1:-1:2, 1:-1:2, 1::2]
                + zz[1:-1:2, 1:-1:2, 1::2]
            ...
            (
                xx[2::2, 1::2, 2:-1:2] + yy[2::2, 1::2, 2:-1:2] + zz[2::2, 1::2, 2:-1:2]
            ).reshape(-1),
            (
                xx[1::2, 2::2, 2:-1:2] + yy[1::2, 2::2, 2:-1:2] + zz[1::2, 2::2, 2:-1:2]
            ).reshape(-1),
        ]
    )
    idx_5 = np.concatenate(
        [
            (xx[1::2, ::2, 1::2] + yy[1::2, ::2, 1::2] + zz[1::2, ::2, 1::2]).reshape(
                -1
            ),
            (
                xx[2:-1:2, 1:-1:2, 1::2]
            ...
            (
                xx[::2, 2::2, 2:-1:2] + yy[::2, 2::2, 2:-1:2] + zz[::2, 2::2, 2:-1:2]
            ).reshape(-1),
        ]
    )
    idx_6 = np.concatenate(
        [
            (
                xx[1::2, 1::2, 1::2] + yy[1::2, 1::2, 1::2] + zz[1::2, 1::2, 1::2]
            ).reshape(-1),
            (
                xx[2:-1:2, 2:-1:2, 1::2]
                + yy[2:-1:2, 2:-1:2, 1::2]
    ...
    idx_7 = np.concatenate(
        [
            (xx[::2, 1::2, 1::2] + yy[::2, 1::2, 1::2] + zz[::2, 1::2, 1::2]).reshape(
                -1
            ),
            (
                xx[1:-1:2, 2:-1:2, 1::2]
...
def gen_idx_1(xx, yy, zz):
    idx_0 = np.concatenate(
        [
            (
                xx[1:-1:2, ::2, ::2] + yy[1:-1:2, ::2, ::2] + zz[1:-1:2, ::2, ::2]
            ).reshape(-1),
            (
                xx[::2, 1:-1:2, ::2] + yy[::2, 1:-1:2, ::2] + zz[::2, 1:-1:2, ::2]
            ).reshape(-1),
            (
                xx[1::2, 1::2, 1:-1:2] + yy[1::2, 1::2, 1:-1:2] + zz[1::2, 1::2, 1:-1:2]
            ).reshape(-1),
            (
                xx[2::2, 2::2, 1:-1:2] + yy[2::2, 2::2, 1:-1:2] + zz[2::2, 2::2, 1:-1:2]
            ).reshape(-1),
        ]
    )
    idx_1 = np.concatenate(
        [
            (xx[2::2, ::2, ::2] + yy[2::2, ::2, ::2] + zz[2::2, ::2, ::2]).reshape(-1),
            (
                xx[1::2, 1:-1:2, ::2] + yy[1::2, 1:-1:2, ::2] + zz[1::2, 1:-1:2, ::2]
            ).reshape(-1),
            (
                xx[::2, 1::2, 1:-1:2] + yy[::2, 1::2, 1:-1:2] + zz[::2, 1::2, 1:-1:2]
            ).reshape(-1),
            (
                xx[1:-1:2, 2::2, 1:-1:2]
                + yy[1:-1:2, 2::2, 1:-1:2]
    ...
    idx_2 = np.concatenate(
        [
            (xx[2::2, 1::2, ::2] + yy[2::2, 1::2, ::2] + zz[2::2, 1::2, ::2]).reshape(
                -1
            ),
            (xx[1::2, 2::2, ::2] + yy[1::2, 2::2, ::2] + zz[1::2, 2::2, ::2]).reshape(
                -1
            ),
            (
                xx[::2, ::2, 1:-1:2] + yy[::2, ::2, 1:-1:2] + zz[::2, ::2, 1:-1:2]
            ).reshape(-1),
            (
                xx[1:-1:2, 1:-1:2, 1:-1:2]
                + yy[1:-1:2, 1:-1:2, 1:-1:2]
                + zz[1:-1:2, 1:-1:2, 1:-1:2]
            ).reshape(-1),
        ]
    )
    idx_3 = np.concatenate(
        [
            (
                xx[1:-1:2, 1::2, ::2] + yy[1:-1:2, 1::2, ::2] + zz[1:-1:2, 1::2, ::2]
            ).reshape(-1),
            (xx[::2, 2::2, ::2] + yy[::2, 2::2, ::2] + zz[::2, 2::2, ::2]).reshape(-1),
            (
                xx[1::2, ::2, 1:-1:2] + yy[1::2, ::2, 1:-1:2] + zz[1::2, ::2, 1:-1:2]
            ).reshape(-1),
            (
                xx[2::2, 1:-1:2, 1:-1:2]
                + yy[2::2, 1:-1:2, 1:-1:2]
    ...
    idx_4 = np.concatenate(
        [
            (
                xx[1:-1:2, ::2, 1::2] + yy[1:-1:2, ::2, 1::2] + zz[1:-1:2, ::2, 1::2]
            ).reshape(-1),
            (
                xx[::2, 1:-1:2, 1::2] + yy[::2, 1:-1:2, 1::2] + zz[::2, 1:-1:2, 1::2]
            ).reshape(-1),
            (
                xx[1::2, 1::2, 2:-1:2] + yy[1::2, 1::2, 2:-1:2] + zz[1::2, 1::2, 2:-1:2]
            ).reshape(-1),
            (
                xx[2::2, 2::2, 2:-1:2] + yy[2::2, 2::2, 2:-1:2] + zz[2::2, 2::2, 2:-1:2]
            ).reshape(-1),
        ]
    )
    idx_5 = np.concatenate(
        [
            (xx[2::2, ::2, 1::2] + yy[2::2, ::2, 1::2] + zz[2::2, ::2, 1::2]).reshape(
                -1
            ),
            (
                xx[1::2, 1:-1:2, 1::2] + yy[1::2, 1:-1:2, 1::2] + zz[1::2, 1:-1:2, 1::2]
            ).reshape(-1),
            (
                xx[::2, 1::2, 2:-1:2] + yy[::2, 1::2, 2:-1:2] + zz[::2, 1::2, 2:-1:2]
            ).reshape(-1),
            (
                xx[1:-1:2, 2::2, 2:-1:2]
                + yy[1:-1:2, 2::2, 2:-1:2]
    ...
    idx_6 = np.concatenate(
        [
            (
                xx[2::2, 1::2, 1::2] + yy[2::2, 1::2, 1::2] + zz[2::2, 1::2, 1::2]
            ).reshape(-1),
            (
                xx[1::2, 2::2, 1::2] + yy[1::2, 2::2, 1::2] + zz[1::2, 2::2, 1::2]
            ).reshape(-1),
            (
                xx[::2, ::2, 2:-1:2] + yy[::2, ::2, 2:-1:2] + zz[::2, ::2, 2:-1:2]
            ).reshape(-1),
            (
                xx[1:-1:2, 1:-1:2, 2:-1:2]
                + yy[1:-1:2, 1:-1:2, 2:-1:2]
                + zz[1:-1:2, 1:-1:2, 2:-1:2]
            ).reshape(-1),
        ]
    )
    idx_7 = np.concatenate(
        [
            (
                xx[1:-1:2, 1::2, 1::2] + yy[1:-1:2, 1::2, 1::2] + zz[1:-1:2, 1::2, 1::2]
            ).reshape(-1),
            (xx[::2, 2::2, 1::2] + yy[::2, 2::2, 1::2] + zz[::2, 2::2, 1::2]).reshape(
                -1
            ),
